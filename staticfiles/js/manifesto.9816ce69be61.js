...
function abrirModalBaixa(numeroNota, chaveAcesso) {
    // 1. Preenche os campos escondidos no Modal
    ...
    // 2. Limpa estados anteriores da câmera e fotos
    ...
    // 3. Abre o modal usando o Bootstrap (certifique-se que a variável 'modalBaixa' existe)
