...
async function abrirScanner() {
    ...
    // Configurações para forçar a câmera traseira e um ângulo melhor
    const constraints = {
        video: {
            facingMode: "environment", // Força a câmera traseira
            width: { min: 1280, ideal: 1920 }, // Alta resolução para ler códigos pequenos
            height: { min: 720, ideal: 1080 }
        }
    };

    try {
        // Inicia o decodificador diretamente com as constraints de vídeo
        ...
        // Se falhar a permissão ou acesso
        alert("Permissão de câmera negada ou não encontrada. Por favor, verifique as configurações do seu navegador.");
    }
}
