...
async function ligarCamera() {
    try {
        // Limpeza de interface antes de começar
        ...
        const constraints = {
            video: {
                // Tenta a traseira, mas não obriga (tiramos o 'exact')
                facingMode: "environment" 
            },
            audio: false
        };

        // Solicita acesso à mídia
        ...
        // Se falhou por não achar a traseira, tenta qualquer uma
        try {
            ...
            alert("Não foi possível acessar nenhuma câmera. Verifique se deu permissão no navegador.");
        }
    }
}
