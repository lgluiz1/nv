...
function filtrarNotasOffline() {
    const termo = document.getElementById('input-busca-nfe').value.toLowerCase().trim();
    const cards = document.querySelectorAll('#lista-notas-container .card');

    cards.forEach(card => {
        // Busca o número da nota, o nome do cliente e a chave de acesso oculta
        const textoCard = card.innerText.toLowerCase();
        const chave = card.getAttribute('data-chave').toLowerCase();
