        ...
        <div class="container pb-5 animate__animated animate__fadeIn">
            <div class="text-center mb-4">
                ...
                <div id="progresso-container" class="mt-2">
                    <span id="contador-notas" class="badge bg-primary px-3 py-2">Verificando Status...</span>
                </div>
            </div>
            ...
            <div id="area-lista-dinamica">
                ...
                <p class="text-center text-muted small mt-2">Sincronizando notas da ESL...</p>
            </div>
        </div>
    `;
    
    // Chama a atualização das notas logo em seguida
