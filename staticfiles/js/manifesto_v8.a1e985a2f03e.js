        ...
        <div class="container pb-5 animate__animated animate__fadeIn">
            ...
            <div class="search-box mb-4 position-relative">
                <div class="input-group shadow-sm" style="border-radius: 15px; overflow: hidden;">
                    ...
                    <input type="text" id="input-busca-nfe" class="form-control border-0 p-3" placeholder="Buscar por Número ou Chave..." oninput="filtrarNotasOffline()">
...
async function atualizarListaViva(numeroManifesto) {
    ...
    <p class="small text-muted mb-1" style="display: none">${nf.chave_acesso}</p>
